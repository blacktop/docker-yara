...
- [alpine:3.7](https://index.docker.io/_/gliderlabs/alpine/)

## Image Tags

```bash
REPOSITORY          TAG                 SIZE
blacktop/yara       latest              55.8MB
